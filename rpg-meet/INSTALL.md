# RPG Meet - Guia de Instalação e Acesso
...
### QR Code
Escaneie o código abaixo com o **Expo Go** para acessar o app:

![RPG Meet QR Code](./expo-qr-code.png)
...
1. Abra o **Expo Go**
2. Clique em **"Scan QR Code"** ou **"Escanear"**
3. Aponte a câmera para o QR Code acima
4. O app será carregado automaticamente

### Passo 3: Comece a Jogar!

Após o carregamento, você verá a tela inicial do RPG Meet.

---

## 🌐 Acesso via Navegador (Web)

1. Abra o link de pré-visualização em seu navegador
2. O app será carregado em modo web
3. Funcionalidade completa disponível

**Nota**: Algumas funcionalidades como câmera/microfone podem ter limitações no navegador.
...
## 🍎 Instalação via TestFlight (iOS)

Para instalar como app nativo no iOS:

1. Clique em **"Publish"** na interface do Manus
2. Aguarde o build ser concluído
3. Receba o link do TestFlight por email
4. Instale via TestFlight
...
3. Preencha o nome da sessão (ex: "Campanha do Reino Perdido")
4. Selecione o tipo de RPG
5. Clique em **"Criar Sala"**
6. Compartilhe o código com seus jogadores

### Para Jogadores

1. Abra o app
2. Clique em **"Entrar em Sala"**
3. Insira o código fornecido pelo mestre
4. Digite seu nome de personagem
5. Clique em **"Entrar"**
6. Aproveite a sessão!
...
- **Câmera/Microfone**: Necessários para videoconferência

### Recomendados

- **iOS**: 14.0 ou superior
- **Android**: 8.0 (API 26) ou superior
- **Internet**: 5+ Mbps para melhor qualidade
...
- [ ] Expo Go instalado (ou navegador moderno)
- [ ] Conexão de internet estável
- [ ] Câmera e microfone funcionando
- [ ] Permissões concedidas ao app
- [ ] Código da sala em mãos (para jogadores)
...
3. Use o link de pré-visualização em vez disso
...
1. Verifique o arquivo `USAGE.md` para instruções detalhadas
2. Consulte o arquivo `README_TECH.md` para informações técnicas
3. Entre em contato através da plataforma Manus
...
**Bom jogo! Que seus dados sempre rolem bem! 🎲**
